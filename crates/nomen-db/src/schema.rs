...
DEFINE FIELD IF NOT EXISTS community_id ON collected_message TYPE option<string>;
DEFINE FIELD IF NOT EXISTS community_type ON collected_message TYPE option<string>;
...
DEFINE FIELD IF NOT EXISTS thread_type ON collected_message TYPE option<string>;
DEFINE FIELD IF NOT EXISTS message_id ON collected_message TYPE option<string>;
...
DEFINE INDEX IF NOT EXISTS cm_community_id ON collected_message FIELDS community_id;
...
DEFINE INDEX IF NOT EXISTS cm_message_id ON collected_message FIELDS message_id;
...
DEFINE INDEX IF NOT EXISTS cm_platform_community_chat ON collected_message FIELDS platform, community_id, chat_id;
